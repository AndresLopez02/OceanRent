...
({Color color, IconData icon, String label}) _statusCfg(LicenseStatus s) =>
    switch (s) {
      ...
      LicenseStatus.none => (
        color: AppTheme.deepNavy.withValues(alpha: 0.50),
...
InputDecoration _fieldDeco({
  ...
  border: OutlineInputBorder(
    ...
    borderSide: BorderSide(color: AppTheme.deepNavy.withValues(alpha: 0.20)),
  ),
...
class _CustomerProfileScreenState extends ConsumerState<CustomerProfileScreen>
  ...
  Future<void> _pickDocument() async {
    ...
    try {
      ...
      final url = await repo.uploadLicenseDocument(
        uid: uid,
...
class _ProfileField extends StatelessWidget {
  ...
  Widget build(BuildContext context) => TextFormField(
    ...
    style: GoogleFonts.openSans(
      fontSize: 15,
      color: readOnly
          ? AppTheme.deepNavy.withValues(alpha: 0.50)
          : AppTheme.deepNavy,
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: hasFile
                  ? AppTheme.oceanBlue.withValues(alpha: 0.04)
                  : Colors.white,
              borderRadius: BorderRadius.circular(12),
              border: Border.all(
                color: hasFile
                    ? AppTheme.oceanBlue.withValues(alpha: 0.4)
                    : AppTheme.deepNavy.withValues(alpha: 0.20),
                width: 1.5,
              ),
            ),
            child: isUploading
