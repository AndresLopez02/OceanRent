...
class LicenseComparer {
  static const Map<String, int> licenseLevels = {
    'none': 0,
    'pbn': 1,
    'per': 2,
  };
  ...
  static bool canDriveBoat({
    ...
    if (nauticalLicense == null ||
        nauticalLicense.status != 'verified') {
      return requiredLicense.toLowerCase() == 'none';
    }

    final userLevel =
        licenseLevels[nauticalLicense.type.toLowerCase()] ?? 0;

    final boatLevel =
        licenseLevels[requiredLicense.toLowerCase()] ?? 0;
